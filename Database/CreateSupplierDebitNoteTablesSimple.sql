-- Simple Supplier Debit Note tables creation
-- This script creates basic tables for the Supplier Debit Note functionality
...
([DebitNoteNo], [DebitNoteBarcode], [SupplierId], [DebitDate], [Reason], [SubTotal], [TaxAmount], [TotalAmount], [Status], [Remarks], [CreatedBy])
VALUES 
('DN20250101001', 'DN20250101001', 1, '2025-01-01', 'Damaged Goods Return', 1000.00, 170.00, 1170.00, 'DRAFT', 'Sample debit note for testing', 1)
GO
