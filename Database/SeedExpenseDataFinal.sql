...
-- Create date: 2025
-- Description: Final seed data for Expense Categories and Expenses tables
-- =============================================
...
SELECT 'Expense data seeded successfully!' AS Message
SELECT 'Total Expense Categories: ' + CAST((SELECT COUNT(*) FROM ExpenseCategories) AS VARCHAR(10)) AS CategoriesCount
SELECT 'Total Expenses: ' + CAST((SELECT COUNT(*) FROM Expenses) AS VARCHAR(10)) AS ExpensesCount
SELECT 'Total Amount: ' + CAST((SELECT SUM(Amount) FROM Expenses) AS VARCHAR(20)) AS TotalAmount
